...
// Copyright (c) 2014 The Delux developers
...
bool ComputeNextStakeModifier(const CBlockIndex* pindexPrev, uint64_t& nStakeModifier, bool& fGeneratedStakeModifier)
{
    ...
    vSortedByTimestamp.reserve(64 * Params().ModifierInterval() / Params().TargetSpacing(pindexPrev->nHeight));
